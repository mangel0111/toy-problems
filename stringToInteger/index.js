...
var myAtoi = function (s) {
  ...
  if (!Number.isInteger(atoiNumber)) {
    return 0;
  }
  if (atoiNumber < minLimit) {
    return minLimit;
  }
  if (atoiNumber >= maxLimit) {
    return maxLimit - 1;
  }
  return atoiNumber;
};
...
console.log("+-12", myAtoi("+-12"));
console.log("+", myAtoi("+"));
console.log("20000000000000000000", myAtoi("20000000000000000000"));
